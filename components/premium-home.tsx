...
const stories = [
  { title: 'Budget Binder', label: '01 / THE FOUNDATION', image: 'https://cdn.builder.io/api/v1/image/assets%2F8c358e96430c4451949ddae1cc8ed29a%2F37d4a72d86c940be9dd6679edbffbff5?format=webp&width=800&height=1200' },
  ...
  return (
    <div className="luxury-home">
      ...
      <section id="designed" className="luxury-product-film" aria-labelledby="designed-title">
        <div className="luxury-film-sticky">
          ...
          <motion.div className="luxury-binder-stage" initial={{ opacity: 0, rotate: -8, scale: 0.86 }} whileInView={{ opacity: 1, rotate: 0, scale: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 1.2, ease: [0.22, 1, 0.36, 1] }}>
            ...
            <Image src="https://cdn.builder.io/api/v1/image/assets%2F8c358e96430c4451949ddae1cc8ed29a%2F3403a3c2686f4f4c80ba772d8a2613e4?format=webp&width=800&height=1200" alt="Pink quilted budget planner" width={1100} height={1100} sizes="(max-width: 767px) 90vw, 54vw" loading="lazy" className="luxury-binder-image" />
          ...
          <div className="luxury-story-track">
            {stories.map((story) => (
              <a href={shopUrl} className="luxury-story-card relative" key={story.title}>
                <Image src={story.image} alt={story.title} fill sizes="(max-width: 767px) 88vw, 72vw" loading="lazy" className="luxury-story-image" />
            ...
            <div className="luxury-story-marquee-copy" aria-hidden="true">
              {stories.map((story) => (
                <a href={shopUrl} className="luxury-story-card relative" key={`marquee-${story.title}`} tabIndex={-1}>
                  <Image src={story.image} alt="" fill sizes="(max-width: 767px) 88vw, 72vw" loading="lazy" className="luxury-story-image" />
                  <div className="luxury-story-wash" />
                  <div className="luxury-story-copy"><p>{story.label}</p><h2>{story.title}</h2><span>Discover <ArrowUpRight size={14} /></span></div>
                </a>
              ))}
      ...
      <section className="luxury-lifestyle relative" aria-labelledby="lifestyle-title">
        <Image src="/images/desk-organizer-bundle.jpg" alt="Budget binder on an organized desk in warm morning light" fill sizes="100vw" loading="lazy" className="luxury-lifestyle-image" />
      ...
      <section className="luxury-featured" aria-labelledby="featured-title">
        ...
        <div className="luxury-featured-grid">
          {featuredPieces.map((piece, index) => <motion.a href={shopUrl} key={piece.title} className={`luxury-featured-piece luxury-featured-${piece.size} relative`} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: index * 0.12 }}><Image src={piece.image} alt={piece.title} fill sizes="(max-width: 767px) 100vw, 50vw" loading="lazy" className="luxury-featured-image" /><div className="luxury-piece-label"><span>{piece.title}</span><ArrowUpRight size={16} /></div></motion.a>)}
        </div>
      </section>

      <section className="luxury-community" aria-labelledby="community-title">
        <div className="luxury-community-photo relative"><Image src="/images/binder-planner-flatlay-collection.png" alt="A considered cash stuffing ritual" fill sizes="(max-width: 767px) 100vw, 50vw" loading="lazy" className="luxury-community-image" /></div>
      ...
      <section className="luxury-final-cta relative" aria-labelledby="final-cta-title">
        <Image src="/images/budget-elegance-planner.jpg" alt="Elegant budget planner and binder collection" fill sizes="100vw" loading="lazy" className="luxury-final-image" />
